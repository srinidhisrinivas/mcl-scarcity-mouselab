...
jsPsych.plugins['mouselab-mdp'] = (function() {
  var Arrow, Edge, KEYS, LOG_DEBUG, LOG_INFO, MouselabMDP, NULL, PRINT, RIGHT_MESSAGE, SIZE, State, Note, TOP_ADJUST, LEFT_ADJUST, TRIAL_INDEX, Text, angle, checkObj, dist, plugin, polarMove, redGreen, removePrivate, round, Flowchart, Tutor, Instructions;
  PRINT = function(...args) {
  ...
  MouselabMDP = class MouselabMDP {
    ...
    buildMap() {
      ...
      if(this.show_pre_select){
        ...
        this.backgroundRect = {'object': rect, 'customStateResponse': (function(){return null;}) }
      }
  ...
  Tutor = class Tutor {
    ...
    constructor(container, config) {
      ...
      this.pred = {'onLevel': null, 'onBestPath': null, 'isUnobserved': null, 'onItsPathIs': null, 'onItsBestPathIs': null};
      this.helper = {'getLevel': null, 'getPathNodes': null, 'getNodeValues': null, 'getBestPathTerms': null, 'getPathValueByTerm': null};
      ...
      this.pred.onItsBestPathIs = function(s,neg,value){
        ...
        return {'answer': this.helper.getNegate(answer, neg), 'text': text, 'beginning': false, 'value': String(value)};
      }
  ...
  Flowchart = class Flowchart extends Tutor{
      ...
      if(index < this.parts.length){
        ...
        if(this.mappings[index].length > 0){
          ...
          if(this.force_correct_clicking){
            let fP = (function(){mdp.displayFeedback("Good", true, 2); return null;});

            if(index == this.images.length-2){
              //click
              let fN = (function(){return mdp.displayFeedback("You reached a CLICK IT decision, please click the selected node again!", false, 3)});
              for(var i in mdp.states){
              ...
              // don't click
              let fN = (function(){return mdp.displayFeedback("The flowchart tells you NOT TO CLICK the selected node, please click a neutral background around this node!", false, 3)});
        ...
        if(index > this.images.length-3 && this.as_auto_select){
          ...
          if(mdp.data.queries.preselect.state.target.length < this.auto_select_N){
            ...
            mdp.complete = true;
            mdp.freeze = true;
            setTimeout(function(){mdp.endTrial();}, 3000);
          }
        }
      }
    }
    ...
    reset(logging = false) {
      if(this.index > 0){
        ...
        for(var i in mdp.states){
          mdp.states[i].customStateResponse = (function(){return null;});
        }
        mdp.backgroundRect.customStateResponse = (function(){return null;});
        mdp.pre_selected = '-';
      }
      if(logging){
  ...
  State = class State {
    constructor(name, left, top, config = {}) {
      ...
      this.customStateResponse = (function(){return null});
