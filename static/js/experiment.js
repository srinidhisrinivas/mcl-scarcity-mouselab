...
<p>
  ...
  distractor["if_node2"] = {
    timeline: [additional_base, test, distractor['final_quiz'], distractor["finish_webofcash"], distractor["color_game_instructions"], ...distractor["distractor_2_timeline"], distractor["finish_webofcash_2"], demographics, finish],
    conditional_function: function() {
      if (REPETITIONS > MAX_REPETITIONS || DEBUG) {
        return false;
      } else {
  ...
  distractor["if_node2_debug"] = {
    timeline: [additional_base, test, distractor["final_quiz"], distractor["finish_webofcash"], distractor["color_game_instructions"], ...distractor["distractor_2_timeline"], distractor["finish_webofcash_2"], finish],
    conditional_function: function() {
      if (REPETITIONS > MAX_REPETITIONS || !DEBUG) {
        return false;
      } else {
