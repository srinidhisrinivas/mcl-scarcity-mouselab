...
initializeExperiment = function() {
  var additional_base, bias_test, click_costs, demographics, experiment_timeline, final_quiz, finish, finish_fail, if_node1, if_node2, instruct_loop, instructions, prompt_resubmit, quiz, reprompt, save_data, secret_code_trial, test;
  $('#jspsych-target').html('');
  //  ============================== #
  //  ========= EXPERIMENT ========= #
  //  ============================== #
...
<p>
  ...
  experiment_timeline = [additional_base, instruct_loop, if_node1, if_node2];
  // ================================================ #
