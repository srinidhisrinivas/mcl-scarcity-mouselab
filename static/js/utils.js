...
var argmax, assert, check, checkObj, checkWindowSize, converter, deepLoadJson, deepMap, delay, fmtMoney, format_date, format_time, getTime, img, loadJson, mapObject, markdown, mean, reformatTrial, sleep, zip;
...
format_time = function(date = null) {
  if (date == null) {
    date = new Date;
  }
...
format_date = function(date = null) {
  if (date == null) {
    date = new Date;
  }
